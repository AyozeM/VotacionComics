...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(()=>{
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("section").find("div").on("click","div",e=>{
        alert(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.currentTarget).data("id"));
    });
...
const getCharacters = () =>{
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
        ...
        success:response=>{
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".characters").find(".preloader").remove();
            response.data.results.map(e=>{
                createHTML({name:e.name,img:`${e.thumbnail.path}.${e.thumbnail.extension}`,id:e.id}).appendTo(".characters");
            })
        },
        data:{apikey:__WEBPACK_IMPORTED_MODULE_1__constants__["a" /* marvelApi */].key,limit:5},
        error:()=>{
            alert("Hubo un fallo");
        },
        beforeSend:()=>{
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".characters").append(
...
const createPreloader = text=>__WEBPACK_IMPORTED_MODULE_0_jquery___default()(`<p class="fas fa-spinner fa-pulse preloader">${text}</p>`)
/**
...
const getLastComics = () =>{
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
        ...
        success:response=>{
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".comics").find(".preloader").remove();
            response.data.results.map(e=>{
                createHTML({name:e.title,img:`${e.thumbnail.path}.${e.thumbnail.extension}`,id:e.id}).appendTo("section .comics");
            });
        },
        beforeSend:()=>{
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".comics").append(
                createPreloader("Cargando comics...")
            )
        },
        data:{apikey:__WEBPACK_IMPORTED_MODULE_1__constants__["a" /* marvelApi */].key,limit:5,dateDescriptor:"lastWeek"},
        error:()=>{
            alert("hubo un error");
        }
    });
