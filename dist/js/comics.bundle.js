 ...
 */
const createError = text =>__WEBPACK_IMPORTED_MODULE_0_jquery___default()(`<p>${text} <i class="fas fa-exclamation-triangle"></i></p>`)
/**
 ...
 * @param {string} text -> texto a visualizar 
 */
const createPreloader = text=>__WEBPACK_IMPORTED_MODULE_0_jquery___default()(`<p class="preloader">${text} <i class="fas fa-spinner fa-pulse"></i></p>`)
/**
 * añade la key de la api a la lista de parametros
 * @param {Object} data -> parametros ya definidos 
 */
const addKey = data => {data == null ? data = {apikey:__WEBPACK_IMPORTED_MODULE_1__constants__["a" /* marvelApi */].key}:data['apikey'] = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* marvelApi */].key;
return data}
/**
...
/* harmony export (immutable) */ __webpack_exports__["b"] = getComics;
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./comics.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./comics.scss");
